...
public class JsNode extends Asset implements SideKickElement{
	...
	static{
		ICON = new ImageIcon(JsNode.class.getResource("/org/liujing/parser/icons/methpub_obj.png"));
	}

	public JsNode(String name,String desc){
		super(name);
		this.desc = desc;
	}

	public JsNode(String name,String desc, int type){
		super(name);
		this.desc = desc;
		this.type = type;
	}
